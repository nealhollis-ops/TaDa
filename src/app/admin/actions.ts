...
function inviteHtml(from: string, plan: Plan, link: string) {
  ...
  return `<!doctype html><html><body style="margin:0;padding:0;background:#EBF5F3;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif;color:#243742;">
...
<p style="margin:0 0 24px;text-align:center;"><a href="${link}" style="display:inline-block;background:#FF6B53;color:#ffffff;text-decoration:none;font-weight:700;font-size:16px;padding:14px 28px;border-radius:999px;">Create my account</a></p>
<p style="margin:0 0 8px;font-size:13px;line-height:1.5;color:#7E9099;">Or copy this link: <span style="word-break:break-all;color:#2C6C8F;">${link}</span></p></td></tr>
<tr><td style="padding:16px 32px 28px;font-size:12px;line-height:1.5;color:#7E9099;border-top:1px solid #D8E5E3;">Questions? Write to clientcare@gettada.me.</td></tr>
