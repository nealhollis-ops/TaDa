...
export const HELP: { id: string; t: string; b: string[] }[] = [
  ...
  { id: "teams", t: "Teams and Boss teams", b: [
    ...
    "Work your boss assigned you carries notes, and you can write them too. Tap the note line under the task on Today to tell them where it stands or what you need; they get told, and only the two of you can read it.",
  ...
  { id: "bossguide", t: "Running a Boss team, step by step", b: [
    ...
    "6. Notes on the work itself. Every assigned task carries its own notes, under the task in Track progress and under it on the member's Today tab. Either of you can add one: say where it stands, ask a question, add the context that didn't fit in the title. Each note tells the other person in their bell, and a push if their alerts are on. Notes stay with the task instead of scattering into chat, and nobody else on the team can read them, not even other members of the same boss team.",
    "7. Talk in two boxes. At the bottom of every boss team card sit two conversations, each in its own box. Team room comes first and everyone on the team reads it. Direct messages sits below it: pick one member from the dropdown and talk privately; they see the thread as Message your boss on their own Boss Mode tab, and only the two of you can read it. A red N new badge on the Direct messages title, and (2 new) beside a name in the dropdown, tell you who is waiting on you.",
    ...
    "8. Watch your seats. Seven member seats are included across all your boss teams, and extras are $9 a month each. One person on two of your teams uses one seat. The seat meter above your teams shows what's in use, and the Your seats roster in Account lists every seat holder with their email and teams.",
    "9. Removing someone. Tap the small X beside their name and confirm. Their unfinished assigned work drops into a holding tank inside the team, where you reassign each task or let it go. Removing a member frees an included seat or ends an extra charge on your next bill; seats are counted once a day.",
