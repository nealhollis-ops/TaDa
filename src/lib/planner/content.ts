...
export const PTYPE_META = {
  question: { label: "Question", color: "#53B29D" },
  win: { label: "Win", color: "#A9781F" },
  boost: { label: "Boost", color: "#FF6B53" },
} as const;
...
export const levelColor = (lv: number) => (lv >= 10 ? "#FF6B53" : lv >= 7 ? "#A9781F" : lv >= 4 ? "#245B76" : "#53B29D");
