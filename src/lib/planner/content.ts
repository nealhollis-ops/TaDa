...
export const PTYPE_META = {
  question: { label: "Question", color: "#50A2A7" },
  win: { label: "Win", color: "#A87A1C" },
  boost: { label: "Boost", color: "#9B2915" },
} as const;
...
export const levelColor = (lv: number) => (lv >= 10 ? "#9B2915" : lv >= 7 ? "#A87A1C" : lv >= 4 ? "#137B90" : "#50A2A7");
